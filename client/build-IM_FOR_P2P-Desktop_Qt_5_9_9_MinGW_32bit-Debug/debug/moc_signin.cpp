...
QT_MOC_LITERAL(1, 7, 17), // "clickSignInSignal"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 17) // "clickSignUpSignal"

    },
    "SignIn\0clickSignInSignal\0\0clickSignUpSignal"
};
...
void SignIn::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clickSignInSignal(); break;
        case 1: _t->clickSignUpSignal(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (SignIn::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SignIn::clickSignInSignal)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (SignIn::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SignIn::clickSignUpSignal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SignIn::clickSignInSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SignIn::clickSignUpSignal()
{
