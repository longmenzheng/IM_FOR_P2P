...
protected:
    ...
    void calc_text_size(); //计算聊天内容的实际高度
...
private:
    ...
    qint32 text_width_spacing;//文字距圆角边框气泡的边框的宽度
    qint32 text_height_spacing;//文字距圆角气泡边框的高度
    qint32 triangle_width;//横向三角形的宽度
    qint32 triangle_height;//横向三角形的高度
    qint32 triangle_height_spacing;//横向三角形距圆角边框气泡的边框的高度
