...
QT_MOC_LITERAL(3, 26, 17) // "clickSignUpSignal"
    ...
    "SignUp\0clickSignInSignal\0\0clickSignUpSignal"
};
...
void SignUp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SignUp::clickSignInSignal)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (SignUp::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SignUp::clickSignUpSignal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SignUp::clickSignInSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SignUp::clickSignUpSignal()
{
